...
export const createUser = async (c) => {
    ...
    try {
        ...
        await query('INSERT INTO users (username, password_hash, role_id, first_name, last_name) VALUES ($1, $2, $3, $4, $5)', [username, hash, role_id, first_name, last_name]);
...
export const createShift = async (c) => {
